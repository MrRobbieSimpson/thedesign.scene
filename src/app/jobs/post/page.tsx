...
import { isStripeConfigured, JOB_POST_AMOUNT_CENTS } from "@/lib/stripe";
...
export const metadata = buildPageMetadata({
  ...
  path: "/jobs/post",
  description:
    "Post a UI or product design opening on sit with design — $70, reviewed before it goes live.",
});
    ...
    <div className="mx-auto w-full min-w-0 max-w-[45rem] px-5 py-10 sm:px-6 sm:py-20">
      <section className="mb-8 space-y-4 sm:mb-10">
        ...
        <h1 className="font-heading text-[1.85rem] tracking-tight text-balance sm:text-5xl">
          Reach designers who sit with craft.
        </h1>
        <p className="text-base leading-relaxed text-muted-foreground sm:text-lg">
          {priceLabel} for one UI / product design opening. Payment holds your
          spot in the review queue — we publish when it meets the bar.
        </p>
      ...
      >
        <JobPostForm defaultEmail={defaultEmail} stripeReady={stripeReady} />
      </Suspense>
    </div>
  );
}
