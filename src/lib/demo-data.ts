...
export const demoEvents: Event[] = [
  {
    ...
    description:
      "Figma’s conference for designers, developers, and product leaders — talks, workshops, and the future of building together.",
    url: "https://config.figma.com/",
    location: "San Francisco, CA",
    latitude: 37.7749,
    longitude: -122.4194,
    startDate: new Date("2026-09-29T16:00:00.000Z"),
    endDate: new Date("2026-09-30T01:00:00.000Z"),
    type: "hybrid",
    status: "published",
    sourcePlatform: "config.figma.com",
    sourceUrl: "https://config.figma.com/",
    externalId: "https://config.figma.com/",
    sourcePayload: null,
    createdAt: now,
    updatedAt: now,
  },
  {
    ...
    description:
      "Three days of morning talks and hands-on afternoon workshops — Discovery, Design, and Delivery.",
    url: "https://2026.uxlondon.com/",
    location: "London, UK",
    latitude: 51.5074,
    longitude: -0.1278,
    startDate: new Date("2026-06-02T08:00:00.000Z"),
    endDate: new Date("2026-06-04T17:00:00.000Z"),
    type: "in-person",
    status: "published",
    sourcePlatform: "2026.uxlondon.com",
    sourceUrl: "https://2026.uxlondon.com/",
    externalId: "https://2026.uxlondon.com/",
    sourcePayload: null,
    createdAt: now,
    updatedAt: now,
  },
  {
    ...
    description:
      "Two days for design leaders — craft, strategy, ROI, and building cultures that ship.",
    url: "https://leadingdesign.com/conferences/london-2026",
    location: "London, UK",
    latitude: 51.5074,
    longitude: -0.1278,
    startDate: new Date("2026-11-11T09:00:00.000Z"),
    endDate: new Date("2026-11-12T18:00:00.000Z"),
    type: "in-person",
    status: "published",
    sourcePlatform: "leadingdesign.com",
    sourceUrl: "https://leadingdesign.com/conferences/london-2026",
    externalId: "https://leadingdesign.com/conferences/london-2026",
    sourcePayload: null,
    createdAt: now,
    updatedAt: now,
  },
  {
    ...
    title: "UX Brighton 2026",
    description:
      "Annual UX conference with a strong theme — this year focused on emerging methods.",
    url: "https://uxbrighton.org.uk/",
    location: "Brighton, UK",
    latitude: 50.8225,
    longitude: -0.1372,
    startDate: new Date("2026-11-06T09:00:00.000Z"),
    endDate: new Date("2026-11-06T18:00:00.000Z"),
    type: "in-person",
    status: "published",
    sourcePlatform: "uxbrighton.org.uk",
    sourceUrl: "https://uxbrighton.org.uk/",
    externalId: "https://uxbrighton.org.uk/2026",
    sourcePayload: null,
    createdAt: now,
    updatedAt: now,
  },
  {
    ...
    latitude: null,
    longitude: null,
    startDate: new Date("2026-09-10T17:00:00.000Z"),
    endDate: new Date("2026-09-10T18:30:00.000Z"),
    type: "remote",
    status: "published",
    sourcePlatform: null,
    sourceUrl: null,
