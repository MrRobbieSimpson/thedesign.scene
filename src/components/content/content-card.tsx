...
function ArticleCard({
  ...
  return (
    <Link
      ...
      className={cn(
        "group flex h-full w-full min-w-0 flex-col justify-between rounded-2xl border bg-card shadow-[0_1px_0_rgba(0,0,0,0.02)] transition-colors duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]",
