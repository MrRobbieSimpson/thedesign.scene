...
/** Events-page organiser nudge — same dark bar as jobs CTA. */
export function EventsPostCta() {
  return (
    <section
      className={cn(
    ...
    >
      <div className="flex flex-col gap-4">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1 text-sm leading-relaxed text-background/65">
              Post it here — {priceLabel}, reviewed before it goes live.
            </p>
          </div>
        </div>
        ...
        <Button
          ...
          render={<Link href="/events/post" />}
          nativeButton={false}
        >
          Post an event — {priceLabel}
        </Button>
      </div>
    </section>
  );
